        ...
        try {
            ...
            resultRows.forEach(new Consumer<Element>() {
                ...
                public void accept(Element rowElement) {
                    ...
                    PirateBaySearchResultItem pirateBaySearchResultItem = 
                        new PirateBaySearchResultItem(
                            type, name, uploadedCalendar, byteSize, 
                            uploadedBy, seeders, leechers, magnetLink, infoHash);
